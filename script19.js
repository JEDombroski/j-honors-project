...
const simulation = d3.forceSimulation(nodes)
    .force("charge", d3.forceManyBody().strength(-100))  // Increase repulsion strength to prevent drifting
    .force("center", d3.forceCenter(width / 2, height / 3)) // Keep nodes centered
